...
function drawText() {
  ...
  if (frameNumber >= 450 && frameNumber < 600) {
    ...
    if (frameNumber >= 1050 && frameNumber < 1200) {
      ...
      if (frameNumber > 2700 && frameNumber < 2850) {
        context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
        context.fillText(
      ...
      if (frameNumber >= 3150 && frameNumber < 3300) {
        context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
        context.fillText(
          "Looking forward to your response and",
          canvas.width / 2,
      ...
      if (frameNumber > 3300 && frameNumber < 3450) {
        context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
        context.fillText(
      ...
      if (frameNumber >= 3450 && frameNumber < 3600) {
        context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
        context.fillText(
          "the countless memories we're about to create! 💌",
          canvas.width / 2,
  ...
  if (frameNumber >= 3900 && frameNumber < 99999) {
